// Code here handles what how the page displays all of the characters It pi ngs
// the server. The server then pings the database and displays all of the
// characters.
...
$.get("/api", (data) => {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    $(`#character-well-${i}`).append(
      `<h3>Force Points: ${data[i].forcePoints}</h4>`
    );
  }
});
